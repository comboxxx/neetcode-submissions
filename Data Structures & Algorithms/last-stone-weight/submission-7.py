class Solution:
    def lastStoneWeight(self, stones: List[int]) -> int:
        ...
        # The Space complexity is O(n log n) because we will traverse through each stone at n time at most and we have pop and push operation inside which take log n time
