...
class LFUCache:
    ...
    def counter(self, key):
        ...
        self.countMap[key] += 1
        # We have to remove it from its current list and add it to the higher frequent list
    ...
    def put(self, key: int, value: int) -> None:
        ...
        self.valMap[key] = value  # Save the vale
        self.counter(key)  # Increment counter and update list map
        self.lfuCount = min(self.lfuCount, self.countMap[key])  # update lfu count
